<?php
	...
	define('MENU_SELECT', 'Selecciona');
	define('MENU_DOWNLOAD', 'Descarrega');
	define('MENU_PREVIEW', 'Visualitza');
	define('MENU_RENAME', 'Renombra');
	define('MENU_EDIT', 'Edita');
	define('MENU_CUT', 'Talla');
	define('MENU_COPY', 'Copia');
	define('MENU_DELETE', 'Esborra');
	define('MENU_PLAY', 'Play');
	define('MENU_PASTE', 'Enganxa');
	
	//Label
		//Top Action
		define('LBL_ACTION_REFRESH', 'Refresca');
		define('LBL_ACTION_DELETE', 'Esborra');
		define('LBL_ACTION_CUT', 'Talla');
		define('LBL_ACTION_COPY', 'Copia');
		define('LBL_ACTION_PASTE', 'Enganxa');
		define('LBL_ACTION_CLOSE', 'Tanca');
		define('LBL_ACTION_SELECT_ALL', 'Selecciona-ho tot');
		//File Listing
	define('LBL_NAME', 'Nom');
	define('LBL_SIZE', 'Mida');
	define('LBL_MODIFIED', 'Modificat a');
		//File Information
	define('LBL_FILE_INFO', 'Informació arxiu:');
	define('LBL_FILE_NAME', 'Nom:');	
	define('LBL_FILE_CREATED', 'Creat:');
	define('LBL_FILE_MODIFIED', 'Modificat:');
	define('LBL_FILE_SIZE', 'Mida arxiu:');
	define('LBL_FILE_TYPE', 'Tipus arxiu:');
	define('LBL_FILE_WRITABLE', 'Permís escriptura?');
	define('LBL_FILE_READABLE', 'Permís lectura?');
		//Folder Information
	define('LBL_FOLDER_INFO', 'Informació carpeta');
	define('LBL_FOLDER_PATH', 'Carpeta:');
	define('LBL_CURRENT_FOLDER_PATH', 'Carpeta actual:');
	define('LBL_FOLDER_CREATED', 'Creat:');
	define('LBL_FOLDER_MODIFIED', 'Modificat:');
	define('LBL_FOLDER_SUDDIR', 'Subcarpetes:');
	define('LBL_FOLDER_FIELS', 'Arxius:');
	define('LBL_FOLDER_WRITABLE', 'Permís escriptura?');
	define('LBL_FOLDER_READABLE', 'Permís lectura?');
	define('LBL_FOLDER_ROOT', 'Carpeta base');
		//Preview
	define('LBL_PREVIEW', 'Visualitza');
	define('LBL_CLICK_PREVIEW', 'Clica per visualitzar.');
	//Buttons
	define('LBL_BTN_SELECT', 'Selecciona');
	define('LBL_BTN_CANCEL', 'Cancel·la');
	define('LBL_BTN_UPLOAD', 'Upload');
	define('LBL_BTN_CREATE', 'Crea');
	define('LBL_BTN_CLOSE', 'Tanca');
	define('LBL_BTN_NEW_FOLDER', 'Nova carpeta');
	define('LBL_BTN_NEW_FILE', 'Nou arxiu');
	define('LBL_BTN_EDIT_IMAGE', 'Edita');
	define('LBL_BTN_VIEW', 'Seleccionat vista');
	define('LBL_BTN_VIEW_TEXT', 'Text');
	define('LBL_BTN_VIEW_DETAILS', 'Detalls');
	define('LBL_BTN_VIEW_THUMBNAIL', 'Miniatures');
	define('LBL_BTN_VIEW_OPTIONS', 'Visualitza dintre:');
	//pagination
	define('PAGINATION_NEXT', 'Següent');
	define('PAGINATION_PREVIOUS', 'Anterior');
	define('PAGINATION_LAST', 'Últim');
	define('PAGINATION_FIRST', 'Primer');
	define('PAGINATION_ITEMS_PER_PAGE', 'Mostra %s elements per pàgina');
	define('PAGINATION_GO_PARENT', 'Ves a la carpeta arrel');
	//System
	define('SYS_DISABLED', 'Permís denegat: El sistema està deshabilitat.');
	
	//Cut
	define('ERR_NOT_DOC_SELECTED_FOR_CUT', 'Cap document seleccionat per tallar.');
	//Copy
	define('ERR_NOT_DOC_SELECTED_FOR_COPY', 'Cap document seleccionat per copiar.');
	//Paste
	define('ERR_NOT_DOC_SELECTED_FOR_PASTE', 'Cap document seleccionat per enganxar.');
	define('WARNING_CUT_PASTE', 'Estàs segur que vols moure els documents a la carpeta actual?');
	define('WARNING_COPY_PASTE', 'Estàs segur que vols copiar els documents seleccionats a la carpeta actual?');
	define('ERR_NOT_DEST_FOLDER_SPECIFIED', 'No has especificat cap carpeta destí.');
	define('ERR_DEST_FOLDER_NOT_FOUND', 'Carpeta destí no trobada.');
	define('ERR_DEST_FOLDER_NOT_ALLOWED', 'No tens permís per moure arxius a aquesta carpeta');
	define('ERR_UNABLE_TO_MOVE_TO_SAME_DEST', 'Error movent arxiu (%s): carpeta orígen és la mateixa que la destí.');
	define('ERR_UNABLE_TO_MOVE_NOT_FOUND', 'Error movent arxiu (%s): arxiu original no existeix.');
	define('ERR_UNABLE_TO_MOVE_NOT_ALLOWED', 'Error movent arxiu (%s): Permís denegat per accedir a l\'arxiu original.');
