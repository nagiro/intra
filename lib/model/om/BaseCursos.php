...
abstract class BaseCursos extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pdf = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->resetModified();
			...
			return $startcol + 21; // 21 = CursosPeer::NUM_COLUMNS - CursosPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[20], $arr)) $this->setPdf($arr[$keys[20]]);
	}
